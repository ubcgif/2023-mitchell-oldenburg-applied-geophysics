...
\captionsetup[subfigure]{labelformat=empty}
   \begin{center}
      ...
      \begin{subfigure}{0.5\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig6b.png}}
      ...
      \begin{subfigure}{0.5\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig6d.png}}
...
\captionsetup[subfigure]{labelformat=empty}
   \begin{center}
      ...
      \begin{subfigure}{0.56\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig7b.pdf}}
...
\captionsetup[subfigure]{labelformat=empty}
   \begin{center}
      ...
      \begin{subfigure}{0.49\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig8b.pdf}}
      ...
      \begin{subfigure}{0.49\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig8d.pdf}}
      ...
      \begin{subfigure}{0.49\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig8f.pdf}}
...
\begin{figure}[htp]{}
   \begin{center}
      \begin{subfigure}{0.54\linewidth}
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig10b.png}}
...
\begin{subfigure}{0.02\linewidth}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig11b.png}}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig11d.png}}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig11f.png}}
...
\begin{figure}[htp]{}
   \begin{center}
      \begin{subfigure}{0.54\linewidth}
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig12b.png}}
...
\begin{subfigure}{0.02\linewidth}
      ...
      \begin{subfigure}{0.53\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig13b.png}}
      ...
      \begin{subfigure}{0.53\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig13d.png}}
      ...
      \begin{subfigure}{0.53\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig13f.png}}
...
\begin{subfigure}{0.02\linewidth}
      ...
      \begin{subfigure}{0.54\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig18b.png}}
      ...
      \begin{subfigure}{0.54\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig18d.png}}
...
\begin{subfigure}{0.02\linewidth}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig22d.png}}
         \includegraphics[height=\ht0,keepaspectratio]{./figures/Fig11e.png}
      \end{subfigure}
      \hspace{-4.0cm}
      \qquad
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig22f.png}}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig22h.png}}
...
\begin{subfigure}{0.02\linewidth}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig24d.png}}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig24f.png}}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig24h.png}}
...
\begin{subfigure}{0.02\linewidth}
      ...
      \begin{subfigure}{0.55\linewidth}
         ...
         \sbox0{\includegraphics[trim=0cm 0cm 0cm 0cm, clip=true,width=\linewidth]{./figures/Fig25f.png}}
